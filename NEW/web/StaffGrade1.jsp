...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">                     
                   <!-- <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#AddFlight">Flight Management</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Ticket">Ticket Management</a>
                    </li>
                    <li class="nav-item">
    ...
    <header class="header">
        <div class="overlay">
            ...
            <h1 class="subtitle">Staff Grade 01 </h1>
        </div>  
        <div class="shape">
 ...
 <div class="row mt-5">
    <div class="col-md-6">
      ...
      <form action="AddFlightServlet" method="post">
          ...
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Flight ID" name="fid" style="border-radius: 15px;">
        
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Airline Name" name="airname" style="border-radius: 15px;">
       
          <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="Date" name="date" style="border-radius: 15px;">
       
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Ticket Price" name="tickprice" style="border-radius: 15px;">
        
     
   
      
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Depature Airport" name="depair" style="border-radius: 15px;">
     
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Arrival Airport" name="arrair" style="border-radius: 15px;">
    ...
    <section class="section" id="Ticket">
        <div class="container">
         ...
         <div class="row mt-5">
            ...
            <h3>Update And Delete Ticket Details</h3>
     <hr>
          
     <input type="text" id="myInput2" onkeyup="myFunction1()" placeholder="Ticket ID" title="Type in a name" style="width:250px; border-radius: 15px;">
     <div class="row mt-5" style="overflow: auto; height: 250px;">
   ...
   %>       
      ...
      <a class="btn btn-primary rounded" href="CRUD Reservation/EditReserv.jsp">Manage Details</a>
 </div> 
 </section>
...
<section class="section" id="Account">
   ...
   <br>
            <a class="btn btn-primary rounded" href="CRUD Flight/EditFlights.jsp">Manage Account Details</a>
        <br><br> 
